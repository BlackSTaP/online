...
(function () {
	...
	var API = Lampa.Utils.protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], user_id = '', uid = '50e44b26987ed2e12061', logged = false;
	var Modss = {
		init: function () {
		...
		snow: function () {
		  if(Lampa.Storage.field('mods_snow') == true)
			$(document).snowfall({
        round:true,
        maxSize:10,
        maxSpeed:5,
    ...
    jack:{					
      ...
      jacc_drstein_xyz: {url:'jacc.drstein.xyz', key:'',lang:'df_lg', interv:'all'},
	...
	var ForkTV = {
		...
		updMac: function (itm) {
			...
			this.user_dev = 'box_client=lg&box_mac=' + this.forktv_id + '&initial=ForkXMLviewer|' + this.forktv_id + '|web-android|' + this.forktv_id + '|MTY3MTgyOTI5NQR=E2161|DE0A8464D885761|android|1|Android_web-android&vr=0&platform=android&country=&tvp=0&hw=1.6&refresh=true';
			Lampa.Storage.set('forktv_id', this.forktv_id);
			clearInterval(ping_auth);
	...
	var Pub = {
		network: new Lampa.Reguest(),
		baseurl: Lampa.Utils.protocol() + 'api.service-kp.com/',
		tock: '5by6q2erh8122y0gjz2ok2cn0gubi81u',
		token: Lampa.Storage.get('pub_access_token', '5by6q2erh8122y0gjz2ok2cn0gubi81u'),
		openBrowser: function (url) {
			if (Lampa.Platform.is('tizen')) {
  ...
  function rezka(component, _object) {
	...
	function collaps(component, _object) {
		...
		var embed = prox ? prox + 'https://api.topdbltj.ws/embed/' : 'https://api.loadbox.ws/embed/';
		var select_title = '';
		var filter_items = {};
	...
	function filmix(component, _object) {
		...
		var dev_token = Filmix.user_dev + token;
		this.search = function (_object, sim) {
      ...
      if (results.serial == 1) {
        ...
        results.translations.forEach(function (translation, keyt) {
          ...
          if (extract[keyt].json[choice.season+1]) {
    ...
    this.initialize = function () {
      var _this = this;
alert (JSON.stringify (filter_sources))
...
alert (b)
    ...
    this.draw = function (items) {
      ...
      this.getEpisodes((object.movie.source == 'pub' || balanser == 'pub') || (object.movie.number_of_seasons >= choice.seasons) ? items[0].season : 1, function (episodes) {
        ...
        var more = episodes.length > items.length && (object.movie.number_of_seasons < choice.seasons)
        var ismore = true;
        if (more){
        ...
        items.forEach(function (element, index) {
          ...
          if (serial && episode) image.append('<div class="online-prestige__episode-number-season">S' + (element.season || episode.snumber || episode.season_number) + ':E' + (element.episode || episode.number || episode.episode_number) + '</div>');
          if (serial && !episode) {
  ...
  function collection(object) {
    ...
    Lampa.Template.add('modss__online_folder', "<div class=\"online-prestige online-prestige--folder selector\">\n            <div class=\"online-prestige__folder\">\n                <svg viewBox=\"0 0 128 112\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n                    <rect y=\"20\" width=\"128\" height=\"92\" rx=\"13\" fill=\"white\"></rect>\n                    <path d=\"M29.9963 8H98.0037C96.0446 3.3021 91.4079 0 86 0H42C36.5921 0 31.9555 3.3021 29.9963 8Z\" fill=\"white\" fill-opacity=\"0.23\"></path>\n                    <rect x=\"11\" y=\"8\" width=\"106\" height=\"76\" rx=\"13\" fill=\"white\" fill-opacity=\"0.51\"></rect>\n                </svg>\n            </div>\n            <div class=\"online-prestige__body\">\n                <div class=\"online-prestige__head\">\n                    <div class=\"online-prestige__title\">{title}</div>\n                    <div class=\"online-prestige__time\">{time}</div>\n                </div>\n\n                <div class=\"online-prestige__footer\">\n                    <div class=\"online-prestige__info\">{info}</div>\n                </div>\n            </div>\n        </div>");
		Lampa.Template.add('modss_style', "<style>.mods_iptv-list{padding:1.5em;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-moz-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;padding-bottom:1em}.mods_iptv-list__ico{width:4.5em;margin-bottom:2em;height:4.5em}.mods_iptv-list__ico>svg{width:4.5em;height:4.5em}.mods_iptv-list__title{font-size:1.9em;margin-bottom:1em}.mods_iptv-list__items{width:80%;margin:0 auto}.mods_iptv-list__items .scroll{height:22em}.mods_iptv-list__item{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;padding:1em;background-color:rgba(255,255,255,0.1);font-size:1.3em;line-height:1.3;-webkit-border-radius:.3em;-moz-border-radius:.3em;border-radius:.3em;margin:1em}.mods_iptv-list__item-name{width:40%;padding-right:1em;overflow:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;white-space:nowrap;text-align:left}.mods_iptv-list__item-url{width:60%;padding-left:1em;overflow:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;white-space:nowrap;text-align:right}.mods_iptv-list__item.focus{background-color:#fff;color:black}@media screen and (max-width: 585px) {.timeline{bottom:12em}.card--new_seria {right:2em!important;bottom:10em!important} .card--last_view{right:80%!important;top:2em!important}}</style>");
    ...
    Lampa.Template.add('mods_iptv_list', "<div class=\"mods_iptv-list layer--height\"><div class=\"mods_iptv-list__ico\"><svg height=\"36\" viewBox=\"0 0 38 36\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n                    <rect x=\"2\" y=\"8\" width=\"34\" height=\"21\" rx=\"3\" stroke=\"white\" stroke-width=\"3\"/>\n                    <line x1=\"13.0925\" y1=\"2.34874\" x2=\"16.3487\" y2=\"6.90754\" stroke=\"white\" stroke-width=\"3\" stroke-linecap=\"round\"/><line x1=\"1.5\" y1=\"-1.5\" x2=\"9.31665\" y2=\"-1.5\" transform=\"matrix(-0.757816 0.652468 0.652468 0.757816 26.197 2)\" stroke=\"white\" stroke-width=\"3\" stroke-linecap=\"round\"/>\n                    <line x1=\"9.5\" y1=\"34.5\" x2=\"29.5\" y2=\"34.5\" stroke=\"white\" stroke-width=\"3\" stroke-linecap=\"round\"/></svg></div><div class=\"mods_iptv-list__title\">#{iptv_select_playlist}</div><div class=\"mods_iptv-list__items\"></div></div>");
    ...
    Lampa.Manifest.plugins = manifest;
      ...
      Modss.init();
			...
			Lampa.SettingsApi.addParam({
				...
				field: {
					...
					description: 'Активация Vip статуса происходит через бота @modssmy_bot, обсуждение в группе @modss_group'
				}
			});
			Lampa.SettingsApi.addParam({
				component: 'settings_modss',
			...
			Lampa.SettingsApi.addParam({
				...
				onRender: function (item) {
					item.on('hover:enter', function(){
					  Lampa.Iframe.show({
              url: 'https://zamerka.com/',
              onBack: function onBack() {
                Lampa.Controller.toggle('console-body');
              }
            });
					});
      ...
      Lampa.Listener.follow('app', function (e) {
		...
		function get$7(method, call) {
			...
			Filmix.network.silent(u, function (json) {
				json.url = method;
				oncomplite(json);
			}, onerror);
		}
        ...
        vote_average: parseFloat(element.rating || '0.0').toFixed(1),
        imdb_rating: parseFloat(element.imdb_rating || '0.0').toFixed(1),
      ...
      if (menu_list.length) oncomplite(menu_list);else {
        ...
        Filmix.network.silent(u, function (j) {
		...
		function person$3(params, oncomplite, onerror) {
			...
			Filmix.network.silent(u, function (json, all) {
				var data = {};
				if (json) {
					data.person = {
						id: params.id,
